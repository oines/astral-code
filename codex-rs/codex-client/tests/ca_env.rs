...
const ASTRAL_CA_CERT_ENV: &str = "ASTRAL_CA_CERTIFICATE";
const PROBE_PROXY_ENV: &str = "ASTRAL_CUSTOM_CA_PROBE_PROXY";
const PROBE_TLS13_ENV: &str = "ASTRAL_CUSTOM_CA_PROBE_TLS13";
const PROBE_URL_ENV: &str = "ASTRAL_CUSTOM_CA_PROBE_URL";
...
fn probe_command() -> Command {
    ...
    cmd.env_remove(ASTRAL_CA_CERT_ENV);
...
fn uses_codex_ca_cert_env() {
    ...
    let output = run_probe(&[(ASTRAL_CA_CERT_ENV, cert_path.as_path())]);
...
fn prefers_codex_ca_cert_over_ssl_cert_file() {
    ...
    let output = run_probe(&[
        (ASTRAL_CA_CERT_ENV, cert_path.as_path()),
...
fn rejects_empty_pem_file_with_hint() {
    ...
    assert!(stderr.contains("ASTRAL_CA_CERTIFICATE"));
