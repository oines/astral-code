...
const TOOL_SUGGEST_DISCOVERABLE_PLUGIN_ALLOWLIST: &[&str] = &[
    ...
    "github@astral-curated-remote",
    "notion@astral-curated-remote",
    "slack@astral-curated-remote",
    "gmail@astral-curated-remote",
    "google-calendar@astral-curated-remote",
    "google-drive@astral-curated-remote",
    "openai-developers@astral-curated-remote",
    "canva@astral-curated-remote",
    "teams@astral-curated-remote",
    "sharepoint@astral-curated-remote",
    "outlook-email@astral-curated-remote",
    "outlook-calendar@astral-curated-remote",
    "linear@astral-curated-remote",
    "figma@astral-curated-remote",
