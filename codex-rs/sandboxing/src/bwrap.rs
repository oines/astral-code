...
const MISSING_BWRAP_WARNING: &str = concat!(
    "Astral could not find bubblewrap on PATH. ",
    "Install bubblewrap with your OS package manager. ",
    "See the sandbox prerequisites: ",
    "https://github.com/oines/astral-code/blob/main/docs/sandbox.md. ",
    "Astral will use the bundled bubblewrap in the meantime.",
);
const USER_NAMESPACE_WARNING: &str =
    "Astral's Linux sandbox uses bubblewrap and needs access to create user namespaces.";
pub(crate) const WSL1_BWRAP_WARNING: &str = concat!(
    "Astral's Linux sandbox uses bubblewrap, which is not supported on WSL1 ",
