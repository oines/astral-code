...
///
/// ```ignore
/// $ jq -C . ~/.astral-code/sessions/rollout-2025-05-07T17-24-21-5973b6c0-94b8-487b-a530-2aeb6098ae0e.jsonl
/// $ fx ~/.astral-code/sessions/rollout-2025-05-07T17-24-21-5973b6c0-94b8-487b-a530-2aeb6098ae0e.jsonl
/// ```
#[derive(Clone)]
            ...
            match serde_json::from_value::<RolloutLine>(v.clone()) {
                Ok(rollout_line) => match rollout_line.item {
                    ...
                    RolloutItem::WorldState(item) => {
                        items.push(RolloutItem::WorldState(item));
                    }
...
fn precompute_log_file_info(
    ...
    // Resolve ~/.astral-code/sessions/YYYY/MM/DD path.
