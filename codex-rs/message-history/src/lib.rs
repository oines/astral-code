...
//!
//! The history is stored at `~/.astral-code/history.jsonl` with **one JSON object per
...
/// Filename that stores the message history inside `~/.astral-code`.
...
pub async fn append_entry(
    ...
    // Resolve `~/.astral-code/history.jsonl` and ensure the parent directory exists.
