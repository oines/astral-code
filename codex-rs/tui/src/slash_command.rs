...
impl SlashCommand {
    ...
    pub fn description(self) -> &'static str {
        match self {
            ...
            SlashCommand::App => "continue this session in Astral-Code Desktop",
            SlashCommand::Quit | SlashCommand::Exit => "exit Astral",
            SlashCommand::Copy => "copy last response as markdown",
            SlashCommand::Raw => "toggle raw scrollback mode for copy-friendly terminal selection",
            SlashCommand::Diff => "show git diff (including untracked files)",
            SlashCommand::Mention => "mention a file",
            SlashCommand::Skills => "use skills to improve how Astral performs specific tasks",
            ...
            SlashCommand::Permissions => "choose what Astral is allowed to do",
