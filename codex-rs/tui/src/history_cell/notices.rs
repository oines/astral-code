...
impl HistoryCell for UpdateAvailableHistoryCell {
    fn display_lines(&self, width: u16) -> Vec<Line<'static>> {
        ...
        let update_instruction = if let Some(update_action) = self.update_action {
            ...
            line![
                "See ",
                "https://github.com/oines/astral-code".cyan().underlined(),
        ...
        let content = text![
            ...
            "https://github.com/oines/astral-code/releases/latest"
                .cyan()
                .underlined(),
        ];
    ...
    fn raw_lines(&self) -> Vec<Line<'static>> {
        let update_instruction = if let Some(update_action) = self.update_action {
            ...
            "See https://github.com/oines/astral-code for installation options.".to_string()
        };
        vec![
            ...
            Line::from("https://github.com/oines/astral-code/releases/latest"),
        ]
    }
...
impl HistoryCell for CyberPolicyNoticeCell {
    fn display_lines(&self, width: u16) -> Vec<Line<'static>> {
        ...
        lines.push(
            vec![
                "ⓘ ".cyan(),
                "The provider requested an additional safety review".bold(),
            ]
            .into(),
        );
        ...
        let body = Line::from(
            "  If this seems wrong, try rephrasing the request or adjust the active provider's safety policy.",
        )
        .dim();
    ...
    fn raw_lines(&self) -> Vec<Line<'static>> {
        vec![
            Line::from("The provider requested an additional safety review"),
            Line::from(
                "If this seems wrong, try rephrasing the request or adjust the active provider's safety policy.",
            ),
        ]
