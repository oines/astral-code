...
// 47348d13ec4508dcfe440e34c6d511bb02998fb2 (Apache-2.0), including its fork of
// ratatui's Terminal implementation (MIT / Apache-2.0 dual license).
...
// See ../NOTICE and the repository root NOTICE.
//
...
fn write_osc8_open<W: Write>(w: &mut W, url: &str, id: Option<u32>) -> io::Result<()> {
    let sanitized: std::borrow::Cow<str> = if url.chars().any(char::is_control) {
