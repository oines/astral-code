...
#[derive(Debug, Parser)]
#[command(bin_name = "astral plugin")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "astral plugin add",
    after_help = "Examples:\n  astral plugin add sample@debug\n  astral plugin add sample --marketplace debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "astral plugin list",
    after_help = "Examples:\n  astral plugin list\n  astral plugin list --marketplace debug\n  astral plugin list --json\n  astral plugin list --available --json"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "astral plugin remove",
    after_help = "Examples:\n  astral plugin remove sample@debug\n  astral plugin remove sample --marketplace debug"
)]
