...
fn new_config(model: Option<String>, arg0_paths: Arg0DispatchPaths) -> anyhow::Result<Config> {
    ...
    let mut config = Config {
        ...
        session_memory_template: None,
        session_memory_update_prompt: None,
        session_memory_minimum_message_tokens_to_init: 100_000,
        session_memory_minimum_tokens_between_update: 20_000,
        session_memory_tool_calls_between_updates: 10,
        notify: None,
        tui_notifications: TuiNotificationSettings::default(),
        tui_variant: Default::default(),
        animations: true,
        show_tooltips: true,
        ...
        hosted_base_url: "https://hosted.example/backend-api/".to_string(),
