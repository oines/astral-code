...
struct GuardianReviewSessionReuseKey {
    ...
    compact_continuation_prompt: Option<String>,
    session_memory_template: Option<String>,
    session_memory_update_prompt: Option<String>,
    cwd: AbsolutePathBuf,
...
impl GuardianReviewSessionReuseKey {
    fn from_spawn_config(spawn_config: &Config) -> Self {
        Self {
            ...
            compact_continuation_prompt: spawn_config.compact_continuation_prompt.clone(),
            session_memory_template: spawn_config.session_memory_template.clone(),
            session_memory_update_prompt: spawn_config.session_memory_update_prompt.clone(),
...
async fn append_guardian_followup_reminder(review_session: &GuardianReviewSession) {
    let reminder: TranscriptItem = ContextualUserFragment::into(GuardianFollowupReviewReminder);
    review_session
        .codex
        .session
